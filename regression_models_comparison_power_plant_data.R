...
rf_regressor = randomForest(x = training_set[-5],
                         y = training_set$PE,
                         ntree = 500)
y_pred = predict(object = rf_regressor, newdata = test_set)
summary(rf_regressor)


#from the predictions on the test set, it is evident that Random forest regressor with n = 500 trees
#is preforming best
